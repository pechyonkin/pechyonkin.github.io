---
layout:     post
title:      Understanding Hinton’s Capsule Networks. Part 1.
date:       2017-11-03
summary:    A non-technical introduction behind the new neural network architecture.
categories: jekyll pixyll
---

### Part of Understanding Hinton’s Capsule Networks Series:

- Part 1: Intuition (you are reading it now)
- Part 2: How Capsules Work
...
{% include image.html
            ...
            title="hinton"
            caption="This is a caption. <a href=\"http://condo.ca/wp-content/uploads/2017/03/Vector-director-Institute-artificial-intelligence-Toronto-MaRS-Discovery-District-Hinton-Google-Apple-Siri-Alexa-Condo.ca_.jpg\">Source</a>." %}
